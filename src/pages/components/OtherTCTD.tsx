      ...
      {form.values.cOtherTCTD.map((row: any, index: number) => (
        <div
          ...
          <div className="col-span-1 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col1`} />
          </div>
          <div className="col-span-1 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col2`} />
          </div>
          <div className="col-span-1 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col3`} />
          </div>
          <div className="col-span-2 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col4`} />
          </div>
          <div className="col-span-2 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col5`} />
          </div>
          <div className="col-span-3 border-r border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col6`} />
          </div>
          <div className="col-span-2 border-black px-1">
            <CustomInput form={form} name={`cOtherTCTD.${index}.col7`} />
          </div>
        </div>
      ))}
    </div>
